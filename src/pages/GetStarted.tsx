        ...
        <div>
            ...
            <section className="bg-gradient-to-r from-[#3D52A0] to-[#7091E6] text-white py-20">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    <p className="text-xl sm:text-2xl text-[#EDE8F5] max-w-2xl mx-auto mb-8">
                        Whether you're starting from scratch or looking to grow, we have the tools and expertise to help you succeed.
                    </p>
                    <Link
                        to="/services"
                        className="bg-white text-[#3D52A0] px-8 py-3 text-lg font-medium rounded-lg shadow-lg hover:bg-[#EDE8F5] transition"
                    >
            ...
            <section className="py-16 bg-white text-gray-800">
                <div className="max-w-7xl mx-auto px-6 text-center">
                    ...
                    <Link
                        to="/services"
                        className="bg-[#3D52A0] text-white px-8 py-3 text-lg font-medium rounded-lg hover:bg-[#7091E6] transition"
                    >
                        ...
                        {[
                            ...
                            >
                                <div className="flex flex-col items-center">
                                    <service.icon className="w-12 h-12 text-[#3D52A0] mb-4" />
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                        {[
                            ...
                            <div key={index} className="text-center bg-white p-6 rounded-lg shadow-lg w-full">
                                ...
                                />
                                <div className="text-4xl font-bold text-[#3D52A0] mb-4">{phase.icon}</div>
            ...
            {/* Contact CTA Section */}
            <section className="py-16 bg-gradient-to-r from-[#3D52A0] to-[#7091E6] text-white text-center">
